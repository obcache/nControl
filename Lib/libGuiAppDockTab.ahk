...
GuiDockTab(&ui)
{
	...
	ui.appDockTopPanel := ui.mainGui.addText("x43 y35 w380 h33 background" cfg.themePanel4color,"")
	ui.appDockBottomPanel := ui.mainGui.addText("x43 y77 w380 h120 background" cfg.themePanel4color,"")
	ui.appDockRightPanel := ui.mainGui.addText("x430 y35 w97 h162 background" cfg.themePanel4Color,"")
	
	drawOutlineNamed("appDockTopPanel",ui.mainGui,45,36,380,33,cfg.themeBorderLightColor,cfg.themeBorderDarkColor,2)

	drawOutlineNamed("appDockRightPanel",ui.mainGui,432,36,92,162,cfg.themeBorderLightColor,cfg.themeBorderDarkColor,2)
	drawOutlineNamed("appDockBottomPanel",ui.mainGui,45,78,380,120,cfg.themeBorderLightColor,cfg.themeBorderDarkColor,2)
	...
	ui.MainGui.AddText("y87 x121 w68 h22 background" cfg.themeBackgroundColor,"  Upper")
	
	drawOutlineNamed("app1label",ui.mainGui,120,85,65,24,cfg.themeBorderLightColor,cfg.themeBorderDarkColor,1)
	ui.SetWorkFileButton := ui.MainGui.AddPicture("x45 y80 w82 h35 section backgroundTrans", "./Img/Button_Select.png")
	...
	ui.app1filename := ui.MainGui.AddText("x187 ys+7 w232 h22 Background" cfg.ThemeEditboxColor,"")
	drawOutlineMainGui(185,85,235,24,cfg.themeBorderLightColor,cfg.themeBorderDarkColor,1)
	ui.MainGui.SetFont("s12 c" cfg.ThemeFont1Color,"Calibri")
	ui.MainGui.AddText("xs+3 y+5 w100 section backgroundTrans","Path")
	ui.MainGui.SetFont("s13 c" cfg.ThemeFont1Color,"Calibri")
	ui.app1path := ui.MainGui.AddText("x84 ys w334 h23 Background" cfg.ThemeEditboxColor,"")
	drawOutlineMainGui(82,112,338,24,cfg.themeBorderLightColor,cfg.themeBorderDarkColor,1)

	ui.MainGui.SetFont("s13 c" cfg.ThemeFont1Color,"Calibri Bold")
	ui.MainGui.AddText("y142 x120 w65 h22 background" cfg.themeBackgroundColor,"  Lower")
	ui.MainGui.SetFont("s14 c" cfg.ThemeFont1Color,"Calibri")
	drawOutlineNamed("app1label",ui.mainGui,120,140,65,24,cfg.themeBorderLightColor,cfg.themeBorderDarkColor,1)
	ui.SetDockFileButton := ui.MainGui.AddPicture("x45 y135 w82 h34 section backgroundTrans backgroundTrans", "./Img/Button_Select.png")
	ui.SetDockFileButton.OnEvent("Click", app2browse)
	ui.SetDockFileButton.ToolTip := "Assigns app to fill remainder of screen"

	ui.MainGui.SetFont("s12 c" cfg.ThemeFont1Color, "Calibri")
	ui.app2filename := ui.MainGui.AddText("x186 ys+7 w232 h22 Background" cfg.ThemeEditboxColor,"")
	drawOutlineMainGui(185,140,235,24,cfg.themeBorderLightColor,cfg.themeBorderDarkColor,1)
	ui.MainGui.SetFont("s12 c" cfg.ThemeFont1Color,"Calibri")
	...
	drawOutlineMainGui(82,167,338,24,cfg.themeBorderLightColor,cfg.themeBorderDarkColor,1)
	...
	ui.MainGui.SetFont("s12 c" cfg.ThemeFont1Color,"Calibri")
	TextDockApps := ui.MainGui.AddText("x410 y40 w80 Right section backgroundTrans backgroundTrans","Dock ")
