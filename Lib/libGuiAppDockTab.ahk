...
GuiDockTab(&ui)
{
	...
	drawOutlineMainGui(211,40,30,25,cfg.themeBorderLightColor,cfg.themeBorderDarkColor,1)
	...
	ui.MainGui.SetFont("s12 c" cfg.ThemeFont1Color, "Calibri")
	ui.app2path := ui.MainGui.AddText("x84 ys-1 w334 h22 Background" cfg.ThemeEditboxColor,"")
	drawOutlineMainGui(82,167,338,25,cfg.themeBorderLightColor,cfg.themeBorderDarkColor,1)
