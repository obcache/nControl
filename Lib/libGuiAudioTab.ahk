...
GuiAudioTab(&ui,&cfg,&audio)
{
	...
	ui.MainGui.SetFont("s11 c" cfg.ThemeFont1Color,"Calibri")
	ui.SpeakerNameEdit	:= ui.MainGui.AddEdit("ys+0 x+0 w210 h25 Background" cfg.ThemeEditboxColor,cfg.SpeakerName)
	ui.SpeakerVolumeSlider := ui.MainGui.AddSlider("ys+0 x+0 w170 h25 AltSubmit Range0-100",cfg.SpeakerVolume)
	ui.MainGui.SetFont("s14 c" cfg.ThemeFont2Color,"Calibri")
	ui.MainGui.AddText("xs+0 y+0 w80 section","Headset")
	ui.ButtonSetHeadset := ui.MainGui.AddPicture("ys+0 x+0 w25 h25","./Img/button_ready.png")
	ui.MainGui.SetFont("s11 c" cfg.ThemeFont1Color,"Calibri")
	ui.HeadsetNameEdit	:= ui.MainGui.AddEdit("ys+0 x+0 w210 h25 Background" cfg.ThemeEditboxColor,cfg.HeadsetName)
